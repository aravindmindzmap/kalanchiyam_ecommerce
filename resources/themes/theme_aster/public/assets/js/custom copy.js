...
function addToCartOnclick() {
    ...
    // in new add to cart
    $(".product-add-to-cart-button-in-product-cart").on("click", function () {
    ...
    if (checkValidityForVariantPrice(formSelector)) {
        ...
        $.post({
            ...
            success: function (response) {
                ...
                $(atc_btn).removeClass('dynamicSectionAbc0').addClass('dynamicSectionAbc' + in_cart_key);
                ...
                // this is new modify
                $('.add-to-cart-box').removeClass('dynamicSectionXyz0').addClass('dynamicSectionXyz' + in_cart_key);
                $(atc_btn).siblings('.qty-input-box').removeClass('dynamicSectionXyz0').addClass('dynamicSectionXyz' + in_cart_key);
        ...
        if (cartQuantity.val() < cartQuantity.data("min")) {
            ...
            $.post(
                ...
                function (response) {
                    ...
                    let getDynamicSectionXyz = $('.dynamicSectionXyz'+cartId);
...
function cartItemRemoveFunction(removeUrl, token, cartId, segment) {
    ...
    $.post(
        ...
        function (response) {
            ...
            let dynamicSectionAbc = $('.dynamicSectionAbc'+cartId);
            ...
            dynamicSectionAbc.removeClass('dynamicSectionAbc'+cartId).addClass('dynamicSectionAbc0');
            dynamicSectionAbc.toggleClass("hide show");

            let dynamicSectionXyz = $('.dynamicSectionXyz'+cartId);
            let get_xyz_original_quantity = dynamicSectionAbc.data('original_quantity');
            dynamicSectionXyz.data('quantity',get_xyz_original_quantity);
            dynamicSectionXyz.data('key',"");
            dynamicSectionXyz.find('input').val(get_xyz_original_quantity);
            dynamicSectionXyz.removeClass('dynamicSectionXyz'+cartId).addClass('dynamicSectionXyz0');

...
function removeAll() {
    $(".remove_tags_Category").trigger('click');
    $(".remove_tags_Brand").trigger('click');
    $(".remove_tags_publishing_house").trigger('click');
    $(".remove_tags_author_id").trigger('click');
    $(".remove_tags_review").trigger('click');
    $(".remove_tags_sortBy").trigger('click');
  }

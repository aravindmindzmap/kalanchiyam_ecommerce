                                ...
                                <div class="swiper-wrapper">
                                    @foreach($relatedProducts as $key=>$relatedProduct)
                                        <div class="swiper-slide">
                                            {{-- @include('theme-views.partials._similar-product-large-card',['product'=>$relatedProduct,'slider'=>'relatedProducts']) --}}
                                            @include('theme-views.partials._product-large-card',['product'=>$relatedProduct,'slider'=>'relatedProducts'])
                                        </div>
                                    @endforeach
                                </div>
                            </div>

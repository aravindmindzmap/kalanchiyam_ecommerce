...
<li onclick="removeAll()" style="list-style: none;" class=" cursor-pointer bg-white text--primary border-0 rounded-16px px-3 py-1 text-nowrap fw-semibold">
    <span class="fs-12">Clear</span>
    <button type="button" class="btn text--primary p-0 m-0 fs-18 border-0 d-inline"><i class="bi bi-x"></i></button>
</li>

<div class="position-relative applied-filer_wrapper d-grid">

                    ...
                    <div class="tab-pane fade show active" id="featured_product" role="tabpanel" tabindex="0">
                        ...
                        <div class="auto-col mobile-items-2 gap-2 gap-sm-3 recommended-product-grid minWidth-12rem">
                            @foreach($featuredProductsList as $product)
                                @if($product)
                                    @include('theme-views.partials._product-large-card',['product'=>$product,'slider' => 'featuredProducts'])
                                @endif
                            @endforeach
                        </div>
                    </div>
                    <div class="tab-pane fade" id="best_selling" role="tabpanel" tabindex="0">
                        ...
                        <div class="auto-col mobile-items-2 gap-2 gap-sm-3 recommended-product-grid minWidth-12rem">
                            @foreach($bestSellProduct as $singleProduct)
                                @include('theme-views.partials._product-large-card',['product'=>$singleProduct,'slider' => 'bestSellProduct'])
                            @endforeach
                        </div>
                    </div>
                    <div class="tab-pane fade" id="latest_product" role="tabpanel" tabindex="0">
                        ...
                        <div class="auto-col mobile-items-2 gap-2 gap-sm-3 recommended-product-grid minWidth-12rem">
                            @foreach($latestProductsList as $product)
                                @if($product)
                                    @include('theme-views.partials._product-large-card',['product'=>$product,'slider' => 'latestProducts'])
                                @endif
                            @endforeach
                        </div>
                    </div>

...
<div class="swiper-slide">
    <a href="javascript:" class="store-product d-flex flex-column gap-2 align-items-center ov-hidden">
        <div class="store-product__top border rounded mb-2 aspect-1 overflow-hidden">
            ...
            @else
            @endif
            <span class="store-product__action preventDefault get-quick-view" data-action="{{ route('quick-view') }}"
        ...
        <a class="fs-16 text-truncate text-muted text-capitalize width--9rem"

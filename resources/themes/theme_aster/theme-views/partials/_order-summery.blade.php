...
<div class="col-lg-4">
    <div class="card text-dark sticky-top-80">
        <div class="card-body px-sm-4 d-flex flex-column gap-2">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                <div class="text-capitalize text-success">{{ translate('product_discount') }}</div>
                <div class="text-success">{{webCurrencyConverter($total_discount_on_product)}}</div>
            </div>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                <div class="text-success">{{ translate('shipping') }}</div>
                <div class="text-success">{{webCurrencyConverter($total_shipping_cost)}}</div>
            </div>
